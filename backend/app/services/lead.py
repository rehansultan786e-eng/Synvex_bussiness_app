...
async def create_lead(lead_data: LeadCreate, sales_rep_id: str, sales_rep_name: str):
    db = get_db()
...
async def update_lead(lead_id: str, lead_data: LeadUpdate, updated_by_role: str):
    """
    ...
    # Flag: caller should create commission if status transitioned to "Won"
