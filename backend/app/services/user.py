...
#
# Service functions for managing super_admin / hr_manager / finance_manager /
# sales_manager / sales_rep users.
# Handles: inviting new users, setting their password via invite link,
# fetching users, listing users, etc.
...
async def set_user_password_via_invite(token: str, new_password: str):
    """
    SRS 9.1: Password must meet complexity policy
